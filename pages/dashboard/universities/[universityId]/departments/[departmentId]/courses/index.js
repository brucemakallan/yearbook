...
const renderActions = (handleDelete, userId, courses, universityId, departmentId) => (
  value,
  _tableMeta,
  _updateValue
) => {
...
const columns = (handleDelete, classes, userId, courses, universityId, departmentId) => [
  {
    name: 'id',
    options: {
      display: false,
  ...
  },
  {
    ...
    options: {
      filter: false,
      sort: false,
      customBodyRender: renderActions(handleDelete, userId, courses, universityId, departmentId),
      setCellProps: (_value) => ({
    ...
    >
      ...
      {getAllCoursesInDepartment.data && (
        <TableView
          ...
          data={courses}
          columns={columns(handleDelete, classes, userId, courses, universityId, departmentId)}
        />
      )}
    </PageWithSidebar>
  );
